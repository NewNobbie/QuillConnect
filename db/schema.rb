...
ActiveRecord::Schema[7.2].define(version: 2024_11_15_144758) do
  ...
  add_foreign_key "posts_categories", "categories", column: "categories_id"
  add_foreign_key "posts_categories", "posts", column: "posts_id"
end
